...
const vBeltFamilies=[
  {name:"Rubber Raw Edge",href:"/products/v-belts/rubber-raw-edge",image:"/assets/megav-dynamic-x.png",copy:"Raw edge cogged construction for improved flexibility, higher power density and compact drives."},
...
const vBeltDetailPages={
  "rubber-raw-edge":{titleTop:"Rubber",titleBottom:"Raw Edge V-Belts",eyebrow:"",quote:"v-belts",heroImage:"/assets/megav-dynamic-x.png",heroCopy:["High-Power Raw Edge Belts - Sourced Through QTM","Raw edge V-belts expose the rubber sidewall directly to the pulley groove, increasing friction and gripping force for higher power-transmission capacity than wrapped constructions.","Many raw edge sections add cogged inner profiles, improving flexibility, reducing bending stress and allowing smaller pulley diameters without sacrificing service life.","Through QTM, customers can access the classic Megadyne raw edge range, the newer MegaV Dynamic family and Continental raw-edge V-belt options."],profileTitle:"Rubber Raw Edge Profile Range",profileCopy:"Raw edge, cogged and variable-speed sections engineered for compact, high-power drives.",families:[{family:"Varisect",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/varisect/",linkImage:"/assets/vbelt-varisect-link.png",description:"Raw edge variable-speed V-belt engineered to maintain grip and consistent power transmission across adjustable pulley systems.",profiles:[["XPZ","https://dam.ammega.com/api/file/redirect/148fc75e-0f9e-48eb-a3c1-a10da8cf7bcc"],["XPA","https://dam.ammega.com/api/file/redirect/60c1b5a4-d1a4-4db3-a40c-8337c018a624"],["XPB","https://dam.ammega.com/api/file/redirect/8ba368e3-5ffb-42c9-b92e-ff21b42678c4"],["XPC","https://dam.ammega.com/api/file/redirect/de76a9ef-8fe4-43df-bf3f-b3569d93e954"]]},{family:"Linea Gold",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/linea-gold/",linkImage:"/assets/vbelt-linea-gold-link.png",description:"Premium raw edge cogged V-belt with enhanced compounds for heavy-duty, high-temperature and high-load applications.",profiles:[["SPZX","https://dam.ammega.com/api/file/redirect/c945402f-1769-4cc8-b334-e607ea0b66c5"],["SPAX","https://dam.ammega.com/api/file/redirect/de76a9ef-8fe4-43df-bf3f-b3569d93e954"],["SPBX","https://dam.ammega.com/api/file/redirect/60c1b5a4-d1a4-4db3-a40c-8337c018a624"],["SPCX","https://dam.ammega.com/api/file/redirect/8ba368e3-5ffb-42c9-b92e-ff21b42678c4"]]},{family:"Linea X",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/linea-x/",linkImage:"/assets/vbelt-linea-x-link.png",description:"Raw edge cogged narrow V-belt delivering high power density, flexibility and reduced vibration in compact drives.",profiles:[["SPZX","https://dam.ammega.com/api/file/redirect/c945402f-1769-4cc8-b334-e607ea0b66c5"],["SPAX","https://dam.ammega.com/api/file/redirect/de76a9ef-8fe4-43df-bf3f-b3569d93e954"],["SPBX","https://dam.ammega.com/api/file/redirect/60c1b5a4-d1a4-4db3-a40c-8337c018a624"],["SPCX","https://dam.ammega.com/api/file/redirect/8ba368e3-5ffb-42c9-b92e-ff21b42678c4"]]},{sectionHeader:"MegaV",sectionCopy:"The MegaV Dynamic range is Megadyne's newer raw-edge platform for high-load, compact and demanding V-belt drives."},{family:"MEGAV Dynamic X",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/megav-dynamic-x/",linkImage:"/assets/vbelt-dynamic-x-link.png",description:"EPDM raw-edge cogged V-belt designed for reliable performance across wide temperatures, high efficiency and reduced maintenance.",profiles:[["AX","https://dam.ammega.com/api/file/redirect/be201cda-547e-4b22-8058-df9ba10debb5"],["BX","https://dam.ammega.com/api/file/redirect/0ccfcfcd-ab69-48f1-929f-4e47859e1e6b"],["CX","https://dam.ammega.com/api/file/redirect/00c58aa0-1656-4f05-93a7-3ba63835342d"]]},{family:"MEGAV Dynamic Max",badge:"New Product",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/megav-dynamic-max/",linkImage:"/assets/vbelt-dynamic-max-link.png",description:"Premium next-generation raw-edge V-belt with advanced EPDM compound, transverse fibers and low-stretch PET cord for demanding industrial and outdoor drives.",profiles:[["XPZ","https://dam.ammega.com/api/file/redirect/148fc75e-0f9e-48eb-a3c1-a10da8cf7bcc"],["XPA","https://dam.ammega.com/api/file/redirect/60c1b5a4-d1a4-4db3-a40c-8337c018a624"],["XPB","https://dam.ammega.com/api/file/redirect/8ba368e3-5ffb-42c9-b92e-ff21b42678c4"],["XPC","https://dam.ammega.com/api/file/redirect/de76a9ef-8fe4-43df-bf3f-b3569d93e954"]]},{sectionHeader:"Continental Raw Edge",sectionCopy:"Continental raw-edge V-belts are built for demanding drives where molded cog flexibility, stable power transmission and reliable service life matter."},{family:"Conti VX Advanced",official:"https://www.continental-industry.com/de/en/products-solutions/power-transmission/v-belts",linkImage:"/assets/conti-vx-advanced-link.png",description:"Raw-edge V-belts for demanding industrial drives, available in standard and advanced versions for sustained power transmission.",profiles:[["XPZ","https://dam.ammega.com/api/file/redirect/148fc75e-0f9e-48eb-a3c1-a10da8cf7bcc"],["XPA","https://dam.ammega.com/api/file/redirect/60c1b5a4-d1a4-4db3-a40c-8337c018a624"],["XPB","https://dam.ammega.com/api/file/redirect/8ba368e3-5ffb-42c9-b92e-ff21b42678c4"],["XPC","https://dam.ammega.com/api/file/redirect/de76a9ef-8fe4-43df-bf3f-b3569d93e954"]]},{family:"CONTI-V FO",official:"https://www.continental-industry.com/de/en/products-solutions/power-transmission/v-belts",linkImage:"/assets/conti-v-fo-link.png",description:"Classic raw-edge cogged Continental V-belt option for compact, high-speed industrial drives and smaller pulley diameters.",profiles:[["AX","https://dam.ammega.com/api/file/redirect/be201cda-547e-4b22-8058-df9ba10debb5"],["BX","https://dam.ammega.com/api/file/redirect/0ccfcfcd-ab69-48f1-929f-4e47859e1e6b"],["CX","https://dam.ammega.com/api/file/redirect/00c58aa0-1656-4f05-93a7-3ba63835342d"],["XPZ","https://dam.ammega.com/api/file/redirect/148fc75e-0f9e-48eb-a3c1-a10da8cf7bcc"],["XPA","https://dam.ammega.com/api/file/redirect/60c1b5a4-d1a4-4db3-a40c-8337c018a624"]]}],benefits:["Higher power density than wrapped belts","Improved flexibility","Reduced pulley diameter","High-speed capability","Modern machinery standard"]},
...
function InquiryForm({kind,product}:{kind:keyof typeof fieldSets;product?:string}){
  const [status,setStatus]=useState(""); const [errors,setErrors]=useState<string[]>([]);
  const submit=(e:FormEvent<HTMLFormElement>)=>{e.preventDefault();const form=new FormData(e.currentTarget);const missing=fieldSets[kind].filter(x=>x.endsWith("*")&&!String(form.get(slugify(x.replace("*","")))||"").trim());const email=String(form.get("email")||"");if(email&&!/^\S+@\S+\.\S+$/.test(email))missing.push("Valid email");setErrors(missing);if(!missing.length){setStatus("Your request has been validated and is ready for QTM. Connect the approved form endpoint before launch to deliver submissions.");e.currentTarget.reset();}};
  return <form className="inquiry-form" onSubmit={submit} noValidate>{product&&<input type="hidden" name="prefilled-product" value={product}/>}<div className="form-grid">{fieldSets[kind].map(label=>{const clean=label.replace("*","");const name=slugify(clean);const large=/message|application|information|interest|industries/i.test(clean);const select=/inquiry type|customer type|product category$/i.test(clean);return <label className={large?"field-wide":""} key={label}><span>{clean}{label.endsWith("*")&&<b> *</b>}</span>{select?<select name={name} defaultValue={clean==="Product category"&&product?product:""}><option value="" disabled>Select</option>{(clean==="Inquiry type"?["Request a Quote","Product Identification","Technical Support","B2B Access","Supplier Inquiry","Partnership","General Inquiry"]:clean==="Customer type"?["Distributor","Reseller","OEM","End User","Service Company","Other"]:products.map(p=>p.name)).map(x=><option key={x}>{x}</option>)}</select>:large?<textarea name={name} rows={4}/>:<input name={name} type={/email/i.test(clean)?"email":/delivery date/i.test(clean)?"date":"text"}/>}</label>})}<label className="field-wide file-field"><span>Photograph or document</span><input type="file" name="file" accept=".pdf,.jpg,.jpeg,.png,.docx,.xlsx"/><small>PDF, JPG, PNG, DOCX or XLSX</small></label><label className="consent field-wide"><input type="checkbox" name="consent" required/><span>I consent to QTM processing this inquiry according to the privacy policy. *</span></label></div>{errors.length>0&&<div className="form-error" role="alert">Please complete: {errors.join(", ")}.</div>}{status&&<div className="form-success" role="status">{status}</div>}<button className="button" type="submit">Submit Inquiry <Arrow/></button></form>;
}
