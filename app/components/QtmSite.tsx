...
const vBeltFamilies=[
  {name:"Rubber Raw Edge",href:"/products/v-belts/rubber-raw-edge",image:"/assets/partnership-megadyne-vbelts-new.png",copy:"Raw-edge V-belts for high-performance drives with superior grip and minimal slippage."},
...
const vBeltDetailPages={
  "rubber-raw-edge":{titleTop:"Rubber",titleBottom:"Raw Edge V-Belts",eyebrow:"",quote:"v-belts",heroImage:"/assets/partnership-megadyne-vbelts-new.png",heroCopy:["High-Performance Raw-Edge V-Belts - Sourced Through QTM","Rubber raw-edge V-belts deliver superior power transmission efficiency through direct edge contact with pulley grooves, providing maximum grip and minimal slippage.","The unprotected rubber edges engage the grooves more effectively than wrapped designs, making raw-edge belts ideal for high-performance and variable-speed applications where efficiency matters most.","Through QTM, customers can access the Megadyne raw-edge range including MEGAV Dynamic-MAX and other advanced formulations engineered for modern drive systems."],profileTitle:"Rubber Raw-Edge Profile Range",profileCopy:"High-efficiency raw-edge sections for demanding power transmission.",families:[{family:"MEGAV Dynamic",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/megav-dynamic/",linkImage:"/assets/partnership-megadyne-vbelts-new.png",description:"Advanced raw-edge V-belt engineered for high-torque and variable-speed drives with enhanced durability and grip.",profiles:["Z","A","B","C","D"]},{family:"MEGAV Dynamic-MAX",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/megav-dynamic-max/",linkImage:"/assets/megadyne-dynamic-max-feature.png",description:"Premium raw-edge V-belt with maximum power density and extended service life for demanding industrial applications.",profiles:["A","B","C"]}],benefits:["Superior power transmission efficiency","Minimal slippage and energy loss","Enhanced grip in high-performance drives","Ideal for variable-speed systems","Extended belt life under load"]},
