...
function getDraftSecret() {
	return "036f235d-dc4c-490c-ad66-fdf0eefb00c0";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a4ffc854-26a5-443f-9da8-de86ff896b9e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a4ffc854-26a5-443f-9da8-de86ff896b9e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a4ffc854-26a5-443f-9da8-de86ff896b9e",
		rootBoundaryId
	});
}
/**
