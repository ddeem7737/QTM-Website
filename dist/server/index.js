...
function getDraftSecret() {
	return "e5459ea0-e517-4ec2-8408-862e32a2ff20";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9eb20a83-6f5c-4cc4-87a1-1f70110444db";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9eb20a83-6f5c-4cc4-87a1-1f70110444db") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9eb20a83-6f5c-4cc4-87a1-1f70110444db",
		rootBoundaryId
	});
}
/**
