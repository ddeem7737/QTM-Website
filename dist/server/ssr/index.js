...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-Be8cy3iY.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DKASmmKj.js");
		return {
			get "ErrorBoundary"() {
	...
	"a5d0b9a34f4c": async () => {
		const m = await import("./assets/QtmSite-CmNtVqRO.js");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { ReadonlyURLSearchParams as a, __toESM as c, app_ssr_entry_default as default, handleSsr, useRouter as i, getLayoutSegmentContext as n, require_react as o, usePathname as r, stripBasePath as s, require_jsx_runtime as t };
